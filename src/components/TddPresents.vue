<template>
  <mdb-container>
    ...
    <mdb-row class="mx-auto pt-2">
        <h2 class="mx-auto text-center p-3 red-text big" style="text-transform: uppercase;">2 levels, 2 days of classes, followed by <i>Beatles On Tap</i> at the Magic Bag Theatre! </h2>
    </mdb-row>
    <mdb-row class="mx-auto pt-2">
        <h4 class="mx-auto text-center p-3 grey-text big" style="text-transform: uppercase;">schedule and registration coming soon!</h4>
    </mdb-row>
    <mdb-row class="mx-auto pt-5">
      <mdb-col lg="4">
          <h2 class="red-text mx-auto text-center big pt-3" style="text-transform: uppercase;">Debbi Dee</h2>
    ...
    <mdb-row class="mx-auto pt-5">
      ...
      <mdb-col lg="8" class="text-justify pt-5">
          <p>Germaine Salsberg was a child actress in her native Canada performing television and radio. She discovered tap dancing after 
              ...
              (Dance Department), Cap 21 (Musical Theater Department), and for almost every major dance organization throughout the US and Canada. 
              She teaches tap for Vocal Performance majors at NYU’s Steinhardt School of Education, and has been a frequent guest teacher throughout 
              the US and internationally. She assisted Tony Award Winner Danny Daniels for Broadway and National tours of "Tap Dance Kid" and has 
              privately coached many actors including Liza Minnelli for the movie "Steppin Out." Germaine has choreographed such regional musical 
              theater productions as 42nd Street, Anything Goes, George M!, Crazy For You, and Dames at Sea, performed tap in Edmonton's Fringe 
              Festival with an hour long tap show called Toe Jamm, as well as at Tap City. In New York she and her husband create and produce a 
              yearly Dance event at Brooklyn College. After over 20 years of helping others to find technique and self expression through tap dance, 
              she entered her own journey of self discovery through choreography with her company, Les Femmes. (2008)  Her company has performed at 
              the 92nd St Y, Symphony Space and the Duke Theater in NYC as part of Tap City and Stampede, Lincoln Center as part of a tribute to Randy 
              Skinner, At the Tap Extravaganza, Boston Tap Festival, Wagner College, the Kumble Theater at LIU, Cedar Crest College PA, Brooklyn College 
              Whitman Theater, and such diverse places as The Friars Club in NYC, street fairs and the Actors Home in New Jersey. <a href="www.germainesalsberg.com" target="_blank" class="red-text">www.germainesalsberg.com</a></p>
</mdb-col>
    </mdb-row>
    <mdb-row class="mx-auto pt-5">
      <mdb-col lg="4">
